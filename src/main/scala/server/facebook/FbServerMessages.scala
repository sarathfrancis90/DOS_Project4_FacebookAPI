...
case class GetUserPhotosReqToFbWorker(startFrom: String, limit: Integer, posts: ListBuffer[String])
...
case class UpdateAlbumPhotoNtf(albumName: String, photoId: String)
